...
export default function PrintBill({ isModalOpen, setIsModalOpen, customer }) {
  //yazıcıya yazdırma işlemi için
              ...
              <div className="bill-table-area mt-8">
                <table className="min-w-full divide-y divide-slate-500 overflow-hidden">
                  ...
                  {customer?.cartItems.map((item) => (
                      <tr className="border-b border-slate-200" id={item._id}>
                      ...
                      <td className="py-4 sm:table-cell hidden">
                        ...
                        <span className="sm:hidden inline-block text-xs">Birim Fiyati {item.price}₺</span>
                        </div>
                      </td>
                ...
                <div className="py-9">
                  <div className="bordwer-t pt-9 border-slate-200">
                    <p className="text-sm font-light text-slate-700">
                      Odeme kosullari 14 gundur. Paketlenmemis Borclarin Gec
                      Odenmesi Yasasi 0000'e gore, serbest calisanlarin bu
                      sureden sonra borclarin odenmemesi durumunda 00.00 gecikme
                      ucreti talep etme hakkina sahip olduklarini ve bu noktada
                      bu ucrete ek olarak yeni bir fatura sunulacagini lutfen
                      unutmayin. Revize faturanin 14 gun icinde odenmemesi
                      durumunda, vadesi gecmis hesaba ek faiz ve %8 yasal oran
                      arti %0,5 Bank of England tabani olmak uzere toplam %8,5
                      uygulanacaktir. Taraflar Kanun hukumleri disinda sozlesme
                      yapamazlar.
                    </p>
                  </div>
                </div>
